...
public class ControlBlinkActivity extends AppCompatActivity {
    ...
    private Button btnBlinky, btnConnect, btnSwitch;
    private ImageView imageBulb;
    private RelativeLayout relativeLayoutControl;
    private LinearLayout linearLayoutButton;
    private View backgroundView;
    private boolean btnSwitchOnOff = false;
    private boolean btnBlinkyOnOff = false;
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            } else btnConnect.setText(getString(R.string.action_connect));
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBlinky.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mBlinkyDevice.isConnected()) {
                    if (btnBlinkyOnOff == true) {
                        mBlinkyDevice.send(false);
                        btnBlinkyOnOff = false;
                    } else {
        ...
        btnSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mBlinkyDevice.isConnected()) {
                    if (btnSwitchOnOff == true) {
                        mBlinkyDevice.send(false);
                        btnSwitchOnOff = false;
                    } else {
                        mBlinkyDevice.send(true);
                        btnSwitchOnOff = true;
                    }
